...
export const linkItems: LinkItemType[] = [
  ...
  {
    type: 'icon',
    url: 'https://github.com/twgrid/react',
    text: 'Github',
    icon: (
...
export const baseOptions: BaseLayoutProps = {
  nav: {
    title: (
      <div className="logo flex items-center gap-1.5 select-none">
        {logo}
        <div className="font-medium [header_&]:text-[16px]">
          <small className="inline-flex font-semibold">TW</small>Grid
        </div>
      </div>
    ),
    transparentMode: 'top',
  ...
  links: [
    {
      ...
      /* items: [
        ...
        },
        {
          icon: <Server />,
          text: 'OpenAPI',
          description: 'Generate interactive playgrounds and docs for your OpenAPI schema.',
          url: '/docs/ui/openapi',
          menu: {
            className: 'lg:col-start-2',
          },
