    ...
    <div className="flex flex-col gap-4 border-x border-t px-8 py-16 md:py-24 lg:flex-row md:px-16">
      <div className="shrink-0 flex-1 font-mono text-start">
        ...
        <p className="text-sm text-fd-muted-foreground mb-6">
          Fumadocs makes it easy to build beautiful docs, and bring the power to transform content
          into data, on Next.js.
          <br />
...
function End(): React.ReactElement {
  return (
    <div className="grid grid-cols-1 border-b border-l border-r md:grid-cols-2 lg:grid-cols-3 rounded-b-xl">
      <div className="relative flex flex-col gap-8 overflow-hidden border-t px-8 py-14">
        <h2 className="text-3xl font-semibold md:text-4xl">Start Building.</h2>
        <ul className="mt-8 flex flex-col gap-6">
          ...
          <li>
            ...
            <span className="mt-2 text-sm text-fd-muted-foreground">Just install the package.</span>
          </li>
        </ul>
...
function Integration({ className, ...props }: HTMLAttributes<HTMLDivElement>): React.ReactElement {
  return (
    <div
      className={cn(
    ...
    >
      <Link href="/docs/ui/openapi" className={cn(linkItemVariants())}>
        ...
        <p className="text-sm text-fd-muted-foreground">Generate docs from your OpenAPI schema.</p>
      </Link>
      <Link href="/docs/mdx" className={cn(linkItemVariants())}>
        <NextSVG className="mb-2 size-12" />
        <p className="text-lg font-medium">Next.js</p>
        <p className="text-sm text-fd-muted-foreground">Enjoy the full power of App Router.</p>
      </Link>
      <Link href="/docs/headless/content-collections" className={cn(linkItemVariants())}>
        <Image
      ...
      <div className="col-span-full">
        ...
        <CodeBlock wrapper={{ className: 'mt-2' }} lang="bash" code="pnpm install @twgrid/react" />
      </div>
      <div className="col-span-full h-[200px] overflow-hidden bg-gradient-to-b from-fd-primary/10 !border-b-0">
        <div
  ...
  return (
    <div className="grid grid-cols-1 border-r md:grid-cols-2 lg:grid-cols-3">
      <div className="col-span-full flex flex-row items-start justify-center border-l border-t p-8 pb-2 text-center">
        <h2 className="bg-yellow-300/50 dark:bg-blue-500 pl-1 text-2xl font-semibold">
          Highlights
        </h2>
    ...
    <div className="relative flex flex-col items-center overflow-hidden border-x border-t px-6 py-8 md:py-16">
      ...
      <div className="mt-6 rounded-xl border bg-gradient-to-b from-secondary p-4 shadow-lg">
        ...
        <div className="mt-4 flex flex-row items-center gap-2">
          ...
          />
          <div>
            <a href="https://shew.dev" rel="noreferrer noopener" className="text-sm font-medium">
              Anthony Shew
            </a>
          ...
          <Link
            href="/showcase"
            className={cn(buttonVariants({ variant: 'outline', className: 'ml-auto' }))}
          >
            Showcase
          </Link>
        </div>
  ...
  return (
    <div className="grid grid-cols-1 border-r md:grid-cols-2">
      <div className="flex flex-col gap-2 border-l border-t px-6 py-12 md:py-16">
        ...
        <h3 className="text-xl font-bold">Install it.</h3>
        <p className="mb-8 text-fd-muted-foreground">Initialize a new docs with a command.</p>
        <CreateAppAnimation />
      </div>
      <div className="flex flex-col gap-2 border-l border-t px-6 py-12 md:py-16">
        <div className={cn(badgeVariants())}>2</div>
        <h3 className="text-xl font-bold">Load your data.</h3>
...
`}
      ...
      <div className="col-span-full flex flex-col items-center gap-2 border-l border-t px-6 py-12 text-center">
        ...
        <p className="text-fd-muted-foreground">
          Deploy anywhere – SPA, SSR, RSC, pick your poison.
        </p>
