...
function TestEvents() {
  ...
  // @ts-expect-error  Argument of type '"cellTripleClick"' is not assignable to parameter of type '"resize" | "debouncedResize" | "unmount" | "cellModeChange" | "cellClick" | "cellDoubleClick" | "cellPointerDown" | "cellMouseUp" | "cellKeyDown" | "cellFocusIn" | ... 49 more'
