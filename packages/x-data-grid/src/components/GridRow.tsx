...
const gridRowsUpdatedAtSelector = (state: GridStateCommunity) => state.rowsUpdatedAt;
const rowNodeSelector = createSelector(
  gridRowTreeSelector,
  gridRowsUpdatedAtSelector,
  (tree, _, id: GridRowId) => tree[id],
);
...
const GridRow = forwardRef<HTMLDivElement, GridRowProps>(function GridRow(props, refProp) {
  ...
  const row = useGridSelector(apiRef, rowSelector, rowId);
  const rowNode = useGridSelector(apiRef, rowNodeSelector, rowId);
